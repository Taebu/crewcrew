        ...
        <div class="container sidebar-toggler">
            <div class="row">
                ...
                <div class="col-xxl-6 col-xl-5 col-lg-8 mt-0 mt-lg-10 mt-xl-0 d-flex flex-column gap-7 cus-z">
					...
					$crew = array();
					$person= array();
					$person['images']= "https://circlehub-react.vercel.app/_next/static/media/story-slider-owner.16eba020.png";
					$person['name']= "Add Story";
					array_push($crew,$person);
					$person['images']= "https://circlehub-react.vercel.app/_next/static/media/story-slider-owner.16eba020.png";
					$person['name']= "Add Story";
					array_push($crew,$person);
					$person['images']= "https://circlehub-react.vercel.app/_next/static/media/story-slider-owner.16eba020.png";
					...
					$person['name']= "Add Story";
					array_push($crew,$person);
					$person['images']= "https://circlehub-react.vercel.app/_next/static/media/story-slider-1.8dfc9736.png";
					$person['name']= "Alen Lio";
					array_push($crew,$person);
                        ...
                        <div class="single-item">
                            <div class="single-slide">
								...
								<a href="#" class="position-relative d-center">
                                    <img class="bg-img" src="<?php echo $crew[$i]['images'];?>" alt="icon">
                                    <div class="abs-area d-grid p-3 position-absolute bottom-0">
										...
										<span class="mdtxt"><?php echo $crew[$i]['name'];?></span>
                                    </div>
                                </a>
